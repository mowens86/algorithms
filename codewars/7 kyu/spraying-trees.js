const task = (w, n, c) => {
   ...
   * a function 'task' that will take 3 arguments(w, n, c):
    ...
    Your function should return string like this : 'It is (weekday) today, (name), you have to work, you must spray (number)
     trees and you need (x) dollars to buy liquid'

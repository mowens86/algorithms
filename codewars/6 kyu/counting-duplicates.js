const duplicateCount = (text) => {
    // Variables
    const duplicatesHolder = [];
    const splitArr = text.toLowerCase().split('');
    // Loop through array
    splitArr.forEach(index => duplicatesHolder.push(text.indexOf(index)));
    // Sort and filter array for duplicates
    const answer = duplicatesHolder
      .sort((a,b) => a-b)
   ...
   * Count the number of Duplicates
    ...
    can be assumed to contain only alphabets (both uppercase
